...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">We'd like to know your accomodation</a>
    </div>
	...
	<div class="col-md-10">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<h3 class="panel-title">YOUR BOOKING PROCESS STARTS HERE</h3>
			</div>
				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-acc">
				      ...
				      <div class="form-group" >
					    ...
					    <input type="number" min="1" class="form-control" name="totalPass" placeholder="Enter no of Passenger" autocomplete="off">
					  </div>
